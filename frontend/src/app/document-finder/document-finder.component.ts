...
@Component({
  selector: 'app-document-finder',
  templateUrl: './document-finder.component.html',
  styleUrls: ['./document-finder.component.scss']
})
export class DocumentFinderComponent implements OnInit {
